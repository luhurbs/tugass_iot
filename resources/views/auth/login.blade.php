            ...
            <div class="row no-gutters">
                <div class="col-sm-6 align-self-center">
                    <div class="sign-in-from">
                        <h1 class="mb-0" style="color: cyan">Sign in</h1>
                        <p style="color: rgb(255, 56, 122)">Enter your email address and password to access admin panel.</p>
                        ...
                        <form class="mt-4" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1" style="color: cyan">Email address</label>
                                <input name="email" type="email" class="form-control mb-0" id="exampleInputEmail1"
                                    placeholder="Enter email" style="background-color: rgb(255, 56, 122)">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1" style="color: rgb(255, 56, 122)">Password</label>
                                <a href="#" class="float-right">Forgot password?</a>
                                <input name="password" type="password" class="form-control mb-0" id="exampleInputPassword1"
                                    placeholder="Password" style="background-color: cyan">
                            </div>
                            <div class="d-inline-block w-100">
                                ...
                                <button type="submit" class="btn btn-primary float-right" style="background-color: rgb(255, 56, 122)">Sign in</button>
                            </div>
                            <div class="sign-info">
                ...
                <div class="col-sm-6 text-center">
                    <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="true"
                        ...
                        <div class="item">
                            <img src="images/g.svg" class="img-fluid mb-4" alt="logo">
                        </div>
                    </div>
                </div>
            </div>
